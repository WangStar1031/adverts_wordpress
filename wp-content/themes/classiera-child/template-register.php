						...
						<div class="col-lg-8 col-sm-11 col-md-9 center-block">
							<form data-toggle="validator" role="form" id="myform" action="" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-3 single-label">
                                            <label for="registerUserRole"><?php esc_html_e('User Role', 'classiera') ?> : <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-lg-9 col-sm-9">
                                            <div class="inner-addon left-addon">
                                            	<i class="left-addon form-icon fa fa-lock"></i>
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox">
                                            ...
                                            <label for="remember"><?php esc_html_e('Agree to', 'classiera') ?> 
												<a href="#" data-toggle="modal" data-target="#tcs"><?php esc_html_e('terms & Conditions', 'classiera') ?></a>
											</label>
...
<!-- Modal -->
<div class="modal fade" id="tcs" tabindex="-1" role="dialog" aria-labelledby="termsandconditions">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="termsandconditions">Terms And Conditions</h4>
      </div>
      <div class="modal-body">
      	<?php echo $redux_demo['tcs-body']; ?>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default adverts-btn" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
