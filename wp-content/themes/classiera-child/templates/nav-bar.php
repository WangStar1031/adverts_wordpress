...
<section class="classiera-navbar  <?php echo esc_attr($affixClass);?> <?php echo esc_attr($classieraSecClass); ?>">
	<div class="<?php echo esc_attr($container); ?>">
		...
		<nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas <?php if(is_rtl()){echo "navmenu-fixed-right";}else{ echo "navmenu-fixed-left"; } ?> <?php echo esc_attr($offcanvasDark); ?>" role="navigation">
			<div class="col-xs-12">
				...
				<ul>
					<?php if(is_user_logged_in()){?>
						<li>
							<a href="<?php echo esc_url($classieraProfileURL); ?>" class="offcanvas-log-reg-btn"><?php esc_html_e( 'My Account', 'classiera' ); ?></a>
						</li>

						<li>
							<a href="<?php echo wp_logout_url(get_option('siteurl')); ?>" class="offcanvas-log-reg-btn"><?php esc_html_e( 'Log out', 'classiera' ); ?></a>	
						</li>
					<?php }else{ ?>
						<li>
							<a href="<?php echo esc_url($classieraLoginURL); ?>" class="offcanvas-log-reg-btn"><?php esc_html_e( 'Login', 'classiera' ); ?></a>
						</li>
						<li>
							<a href="<?php echo esc_url($classieraRegisterURL); ?>" class="offcanvas-log-reg-btn"><?php esc_html_e( 'Get Registered', 'classiera' ); ?></a>
						</li>
					<?php } ?>
				</ul>
				<?php 
				...
				<?php if( is_user_logged_in() && $isMobile) { ?>
					    ...
					    <ul>
							...
							<!-- Get Credits -->
					    	<?php if(!in_array( 'user', (array) $current_user->roles )): ?>
						    	<li class="<?php if(is_page_template( 'template-get-credits.php' )){echo "active";}?>">
					    	...
					    	<?php if(!in_array( 'user', (array) $current_user->roles ) && $is_Exist): ?>
						    	<li class="<?php if(is_page_template( 'template-confirm-images.php' )){echo "active";}?>">
