...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		init: function () {
			...
			var oriW = that.obj.attr("originalW");
			var oriH = that.obj.attr("originalH");
			console.log(oriW);
			console.log(oriH);
			that.cropW = that.obj.width();
			that.cropH = that.obj.height();
			if( oriW ) that.cropW = oriW;
			if( oriH ) that.cropH = oriH;
