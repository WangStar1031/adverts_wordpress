	...
	<div class="user-comments border-bottom">
		...
		?>
			<tr style="padding: 10px 0px">
				<td>
					<img src="<?=$avatar?>" style="width: 42px; border-radius: 100%; float: left;">
				</td>
				<td>
				...
				<div class="form-inline row">
					...
					<div class="form-group col-sm-7">
						...
						<div class="inner-addon left-addon">
							<input type="text" name="author" class="form-control form-control-sm" placeholder="<?php esc_html_e( 'Enter name','classiera' ); ?>" data-error="<?php esc_html_e( 'name required','classiera' ); ?>" required value="">
