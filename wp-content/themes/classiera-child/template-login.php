					...
					<div class="row">
                        <div class="col-lg-12">
                            <div class="classiera-login-register-heading border-bottom text-center">
                                <h3 class="text-uppercase" style="color: white;"><?php esc_html_e('Login', 'classiera') ?></h3>
							...
							<form data-toggle="validator" method="POST" id="classiera_login_form" name="classiera_login_form">
								...
								<div class="col-lg-9 pull-right flip">
                                    ...
                                    <div class="form-group">
										...
										<button class="btn btn-primary" id="edit-submit" name="op" value="Login" type="submit"><?php esc_html_e('LOGIN NOW', 'classiera') ?></button>
                                    </div>									
                                    <div class="form-group">
